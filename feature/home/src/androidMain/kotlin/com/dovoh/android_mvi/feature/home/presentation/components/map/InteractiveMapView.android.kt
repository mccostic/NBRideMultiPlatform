...
import com.google.android.gms.maps.OnCameraIdleListener
...
actual fun InteractiveMapView(
    ...
    // Report camera position changes when user pans the map
    LaunchedEffect(cameraPositionState.position) {
        val position = cameraPositionState.position.target
        onCameraPositionChanged(position.latitude, position.longitude)
    }
}